...
#include <assert.h>
#if __has_include(<debug/debug.h>)
# include <debug/debug.h>
#endif

#ifndef _GLIBCXX_DEBUG_ONLY
# ifdef _GLIBCXX_DEBUG
#  define _GLIBCXX_DEBUG_ONLY(X) X
# else
...
# ifdef _GLIBCXX_DEBUG
#  define _GLIBCXX_DEBUG_ASSERT(X) assert(X)
# else
#  define _GLIBCXX_DEBUG_ASSERT(X)
# endif
#endif

#ifndef _GLIBCXX_DEBUG_VERIFY_AT
# define _GLIBCXX_DEBUG_VERIFY_AT(Cond, Msg, File, Line) assert(Cond)
struct _M_message {
    _M_message(const char*) {}
    _M_message& _M_string(const char*) { return *this; }
    _M_message& _M_integer(int) { return *this; }
};
#endif
