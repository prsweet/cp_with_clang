...
#if __has_include(<ext/type_traits.h>)
...
namespace __gnu_cxx
{
  ...
  {
    typedef typename std::conditional<_Cond, _Iftrue, _Iffalse>::type __type;
  };
}
#endif

#if __has_include(<ext/numeric_traits.h>)
...
namespace __gnu_cxx
{
  ...
  {
    static const bool __is_signed = std::numeric_limits<_Value>::is_signed;
    static const _Value __min = std::numeric_limits<_Value>::min();
    static const _Value __max = std::numeric_limits<_Value>::max();
  };
}
#ifdef __clang__
...
namespace __gnu_pbds
{
  namespace detail
  {
    ...
    typedef std::integral_constant<int, 1> true_type;
    typedef std::integral_constant<int, 0> false_type;
#else
